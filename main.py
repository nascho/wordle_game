import pygame
# cleans program on exit
import sys
# randomto select random word
import random
# importing file with words list
from words import *
...
# w = win, l = lose or empty if on-going game
game_result = ""
...
class Letter:
    ...
    def __init__(self, text, bg_position):
        # initialises all the variables, including text, colour, position, size, etc.
        self.bg_color = "white"
    ...
    def draw(self):
        ...
        # render text again, if colour of text changed need to display again
        self.text_surface = GUESSED_LETTER_FONT.render(self.text, True, self.text_color)
        SCREEN.blit(self.text_surface, self.text_rect)
        pygame.display.update()

    def delete(self):
        # fills the letters spot with the default square, emptying it.
...
class Indicator:
    ...
    def __init__(self, x, y, letter):
        # initialises variables such as colour, size, position, and letter.
        self.x = x
        self.y = y
        self.text = letter
